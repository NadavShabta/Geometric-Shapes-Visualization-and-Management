...
public class Ex4_main {
	...
	public static void simpleShapes() {//
		...
		Polygon_2D c3  = new Polygon_2D();
		c3.add(new Point_2D(0,0));
		c3.add(new Point_2D(3,0));
		c3.add(new Point_2D(5,1));
		c3.add(new Point_2D(7,3));
		c3.add(new Point_2D(5,3));
		c3.add(new Point_2D(3,5));
		GUI_Shape gs1 = new GUIShape(c1, true, Color.black, 1);
		GUI_Shape gs2 = new GUIShape(c2, true, Color.yellow, 2);
		GUI_Shape gs3 = new GUIShape(c3, true, Color.green, 2);
    	shapes.add(gs1);
		shapes.add(gs2);
		shapes.add(gs3);
		ex4.init(shapes);
